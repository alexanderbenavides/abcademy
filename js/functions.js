(function ($) {
	...
	var $menu = $("nav#menu").mmenu({
		...
		navbars: [{position:'bottom',content: ['<a href="#0">© 2019 Abcademy</a>']}]},
		{
		// configuration
		clone: true,
		classNames: {
  ...
  /*Calificación-ranking */
	...
	/* Fin Calificación-ranking */

	/*sección de click fotos videos*/
	$( ".photos_section" ).on( "click", function() {
		$(".products_imgs").css("display","block");
		$(".products_videos").css("display","none");
	});

	$( ".videos_section" ).on( "click", function() {
		$(".products_imgs").css("display","none");
		$(".products_videos").css("display","block");
	});
	/*Fin de sección de click fotos videos*/
